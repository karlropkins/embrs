...
transition published as [Tivey et al 2023](https://doi.org/10.3390/su15021522){target="_blank"}
...
You can install the development version of embrs from [Github](https://github.com/){target="_blank"} with:
